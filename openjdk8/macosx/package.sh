...
JDK_DST_BUNDLE_DIRNAME=1.8.0$FILENAME_PREFIX.jdk
JRE_DST_BUNDLE_DIRNAME=1.8.0$FILENAME_PREFIX.jre
...
build_dmg jdk $JDK_BUNDLE $JDK_ORG_BUNDLE_DIRNAME $JDK_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8$FILENAME_PREFIX
build_dmg jre $JRE_BUNDLE $JRE_ORG_BUNDLE_DIRNAME $JRE_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8$FILENAME_PREFIX
