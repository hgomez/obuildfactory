...
JDK_DST_BUNDLE_DIRNAME=1.8.0-jigsaw$FILENAME_PREFIX.jdk
JRE_DST_BUNDLE_DIRNAME=1.8.0-jigsaw$FILENAME_PREFIX.jre
...
# FILE_NAME = OpenJDK-OSX-1.8/OpenJDK-OSX-1.8-fastdebug
#
function build_dmg()
{
    PACKAGE_NAME=$1
...
# OpenJDK-OSX-1.8/OpenJDK-OSX-1.8-fastdebug

build_dmg jdk $JDK_BUNDLE $JDK_ORG_BUNDLE_DIRNAME $JDK_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8-jigsaw$FILENAME_PREFIX
build_dmg jre $JRE_BUNDLE $JRE_ORG_BUNDLE_DIRNAME $JRE_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8-jigsaw$FILENAME_PREFIX
