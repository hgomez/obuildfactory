...
JDK_DST_BUNDLE_DIRNAME=1.8.0-lambda$FILENAME_PREFIX.jdk
JRE_DST_BUNDLE_DIRNAME=1.8.0-lambda$FILENAME_PREFIX.jre
...
DMG_BUNDLE_DIR=1.8.0-lambda.jdk
...
# FILE_NAME = OpenJDK-OSX-1.8-lambda/OpenJDK-OSX-1.8-lambda-fastdebug
#
function build_dmg()
{
    PACKAGE_NAME=$1
...
# OpenJDK-OSX-1.8-lambda/OpenJDK-OSX-1.8-lambda-fastdebug

build_dmg jdk $JDK_BUNDLE $JDK_ORG_BUNDLE_DIRNAME $JDK_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8-lambda$FILENAME_PREFIX
build_dmg jre $JRE_BUNDLE $JRE_ORG_BUNDLE_DIRNAME $JRE_DST_BUNDLE_DIRNAME OpenJDK-OSX-1.8-lambda$FILENAME_PREFIX
